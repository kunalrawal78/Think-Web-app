...
function SideNavTopSection({user,setActiveTeamInfo}:any) {
    ...
    return (
        ...
        <Popover>
            <PopoverTrigger>
            <div className='flex items-center mt-10 hover:bg-slate-300 bg-white p-2 rounded-lg cursor-pointer h-10 w-60 '>
        <Image src={k} alt='logo' height='20' width='50' className=' rounded-md'/>
