...
import { Archive, ArchiveIcon, MoreHorizontal } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const router=useRouter();
  ...
  <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
    ...
    <tbody className="divide-y divide-gray-200">
      {fileList_&&fileList_.map((file:FILE,index:number)=>
       <tr className="odd:bg-gray-50 cursor-pointer hover:bg-blue-100"
       ...
       <td className="whitespace-nowrap px-4 py-2 text-gray-700">  <Image src={user?.picture} width={30} height={30} alt="user"/>  </td>
